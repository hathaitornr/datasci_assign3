...
num_ftrs = model_cnn.classifier[0].out_features
...
# opoosed to before.
optimizer_conv = optim.SGD(model_cnn.fc.parameters(), lr=0.001, momentum=0.9)
...
model_cnn = train_model(model_cnn, criterion, optimizer_conv,
